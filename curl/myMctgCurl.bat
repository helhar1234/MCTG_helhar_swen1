...
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"username\":\"cardslasher\",    \"password\":\"passwort1234\"}"
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"username\":\"max\",    \"password\":\"muster\"}"
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"username\":\"paula\",    \"password\":\"mysecret\"}"
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"username\":\"anna\",    \"password\":\"topsecret\"}"
echo.
...
echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"username\":\"cardslasher\",    \"password\":\"passwort1234\"}"
echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"username\":\"max\",    \"password\":\"muster\"}"
echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"username\":\"paula\",    \"password\":\"mysecret\"}"
echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"username\":\"anna\",    \"password\":\"topsecret\"}"
echo.
...
echo.
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"id\":\"b2237eca-0271-43bd-87f6-b22f70d42ca2\", \"name\":\"Goblin\", \"damage\": 44.0}, {\"id\":\"9e8238a4-8a7a-487f-9f7d-a8c97899eb4q\", \"name\":\"FireElf\", \"damage\": 23.0}, {\"id\":\"d60e23cf-2238-4d49-844f-c7589ee5342q\", \"name\":\"WaterSpell\", \"damage\": 17.0}, {\"id\":\"fc305a7a-36f7-4d30-ad27-162ca0445649\", \"name\":\"Dragon\", \"damage\": 84.0}, {\"id\":\"84d276ee-21ec-4171-a509-c1b8816283qc\", \"name\":\"FireSpell\", \"damage\": 55.0}]"
echo.
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"id\":\"b2237ecq-0271-43bd-87f6-b22f70d42ca4\", \"name\":\"Goblin\", \"damage\": 18.0}, {\"id\":\"9e8238a4-8a7a-487f-9f7d-q8c97899eb48\", \"name\":\"FireElf\", \"damage\": 5.0}, {\"id\":\"d60e23cf-2238-4d49-844f-c7589eeq342e\", \"name\":\"WaterSpell\", \"damage\": 38.0}, {\"id\":\"fc305a7a-36f7-4d30-adq7-462ca0445649\", \"name\":\"Knight\", \"damage\": 45.0}, {\"id\":\"84d276ee-21ec-4171-a509-c1b88162531c\", \"name\":\"Wizzard\", \"damage\": 35.0}]"
echo.
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"id\":\"b2837ecq-0271-43bd-87f6-b22f70d42ca4\", \"name\":\"FireElf\", \"damage\": 25.0}, {\"id\":\"9e8238a4-8a7a-487f-9f7d-q8c97899eb41\", \"name\":\"Dragon\", \"damage\": 39.0}, {\"id\":\"d60e23cf-2q38-sd49-844f-c7589eeq342e\", \"name\":\"Kraken\", \"damage\": 38.0}, {\"id\":\"fc305a7a-3617-4d30-adq7-462ca0445649\", \"name\":\"Knight\", \"damage\": 45.0}, {\"id\":\"84d276ee-21qc-4171-a509-c1b88162531c\", \"name\":\"Wizzard\", \"damage\": 55.0}]"
echo.
echo.
...
REM --------------------------------------------------
echo acquire packages max
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer max-mtcgToken" -d ""
echo.
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer max-mtcgToken" -d ""
echo.

REM --------------------------------------------------
echo acquire packages anna
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer anna-mtcgToken" -d ""
echo.
echo.
...
echo configure deck max
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer max-mtcgToken" -d "[\"b2237eca-0271-43bd-87f6-b22f70d42ca2\", \"9e8238a4-8a7a-487f-9f7d-a8c97899eb4q\", \"fc305a7a-36f7-4d30-ad27-162ca0445649\", \"d60e23cf-2238-4d49-844f-c7589eeq342e\"]"
echo.
echo configure deck anna
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer anna-mtcgToken" -d "[\"b2837ecq-0271-43bd-87f6-b22f70d42ca4\", \"9e8238a4-8a7a-487f-9f7d-q8c97899eb41\", \"d60e23cf-2q38-sd49-844f-c7589eeq342e\", \"84d276ee-21qc-4171-a509-c1b88162531c\"]"
echo.
...
start /b "max battle" curl -X POST http://localhost:10001/battles --header "Authorization: Bearer max-mtcgToken"
start /b "anna battle" curl -X POST http://localhost:10001/battles --header "Authorization: Bearer anna-mtcgToken"
echo.
echo Should fail (no Opponent found -> Response should follow in 1 min)
start /b "altenhof battle2" curl -X POST http://localhost:10001/battles --header "Authorization: Bearer altenhof-mtcgToken"
...
REM --------------------------------------------------
echo 3) create packages for wheel spin (done by "admin")
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "[{\"id\":\"845f0dc7-37d0-426e-991e-43fc3ac83c08\", \"name\":\"WaterGoblin\", \"damage\": 10.0}, {\"id\":\"99f8f8dc-e25e-4a9k-aa2c-782823f36e2a\", \"name\":\"Dragon\", \"damage\": 50.0}, {\"id\":\"ev5e3976-7c86-4d06-9a80-641c2019a79f\", \"name\":\"Wizzard\", \"damage\": 20.0}, {\"id\":\"1cb6ab8k-bdb2-47e5-b6e4-68c5ab389334\", \"name\":\"Ork\", \"damage\": 45.0}, {\"id\":\"dfdd758f-649c-40f9-ba3a-8657f4l3439f\", \"name\":\"FireSpell\",    \"damage\": 25.0}]"
echo.

echo 22) Spin the wheel of Fortune
curl -X POST http://localhost:10001/wheel --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X POST http://localhost:10001/wheel --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo should fail (already spun wheel today):
curl -X POST http://localhost:10001/wheel --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X POST http://localhost:10001/wheel --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken"
echo.
