...
class WheelOfFortuneServiceTest {
    ...
    void shouldAwardCoinsOnSuccessfulSpin() {
        ...
        WheelOfFortuneService service = new WheelOfFortuneService(
                mockedWheelOfFortuneRepository, mockedUserRepository,
                mockedCardRepository, mockedCoinRepository, mockedRandom);
    ...
    void shouldThrowExceptionWhenUserHasAlreadySpun() {
        ...
        WheelOfFortuneService service = new WheelOfFortuneService(
                mockedWheelOfFortuneRepository, null, null, null, null);
